...
$(function(e){
  'use strict'
	...
	/* Chartjs (#linechart) */
	// var myCanvas = document.getElementById("line-chart1");
	// var pending = document.getElementById("PendingRevenue").value;
	// var complete = document.getElementById("CompleteRevenue").value;
 ...
 //    var myChart = new Chart( myCanvas, {
	// 	type: 'line',
	// 	data: {
	// 		labels: ['3 Mar', '04 Mar', '05 Mar', '06 Mar', '07 Mar', '08 Mar', '09 Mar', '10 Mar', '11 Mar', '12 Mar'],
	// 		datasets: [{
	// 			label: 'Pending Order',
