...
<div class="breadcrumbs_area contact_bread">
	  ...
	  <a href="<?=base_url();?>"><i class="fa fa-home"></i></a>
            ...
            <div class="owl-item col-md-3" ><div class="item"> <div class="card bg-success-transparent"> <div class="card-body"> <h6 class="mb-3">Total Participants</h6> <h2 class="text-right mb-4"><i class="fa fa-product-hunt text-success text-success-shadow fa-lg float-left"></i><span><?php echo $total_participants; ?></span></h2>  </div> </div> </div></div>
