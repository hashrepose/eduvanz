...
<html class="no-js" lang="zxx">
   <head>
      ...
      <link href="<?php echo base_url();?>assets/plugins/bootstrap-colorpicker/bootstrap-colorpicker.min.css" rel="stylesheet">
                  ...
                  <div class="col-lg-3">
                     <div class="top_left_sidebar left_sidebar_two">
                        <div class="logo logo_four">
                           ...
                           <img src="<?php echo base_url().'upload/website/logo/logo.png'; ?>" title="Eduvanz"></a>
                        </div>
                     </div>
                  </div>
                              ...
                              <a href="javascript:void(0);">
                                 <div style="display: flex;">
                                    <span class="vendor-name">
                                       <br>
                                       <p class="seller">Admin</p>
                                    </span>
                                 </div>
                              </a>
                              <ul class="dropdown_languages">
                                 <li class="select"><a href="<?php echo base_url('login/logout');?>"><i class="fa fa-sign-out" aria-hidden="true"></i> Log out </a></li>
                              </ul>
                           </li>
                        </ul>
                     </div>
                  ...
                  <div class="col-lg-12">
                     <div class="main_menu_inner menu_inner_four">
                        <div class="main_menu menu_four d-none d-lg-block">
                           <nav>
                              <ul>
                              <li class="<?php echo'active';?>"><a href="<?php echo base_url('dashboard');?>"><i class="fa fa-dashboard"></i>Dashboard </a></li>
                              <li class="dropdown_item">
                                 <a href="javascript:void(0);"><i class="fa fa-th"></i> Participants<i class="fa fa-angle-down"></i></a>
                                 <ul class="sub_menu">
                                    <li><a href="<?php echo base_url('participant/getAll');?>"><i class="fa fa-angle-right"></i>List Participant</a></li>
                                 </ul>
                              </li>
                              <li class=""><a href="<?php echo base_url('login/logout');?>"><i class="fa fa-sign-out"></i>Logout </a></li>
                           </nav>
                        </div>
                     </div>
                  </div>
